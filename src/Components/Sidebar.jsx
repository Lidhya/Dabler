...
const Sidebar = () => {
  ...
  return (
    <div className=" flex flex-col w-full h-1/2 items-center justify-start">
      ...
      <Link
        to={"/"}
        className={`cursor-pointer p-4 w-full text-white flex gap-3 flex-wrap ${
          active === 1 && "bg-light-blue"
        }`}
        onClick={() => setActive(1)}
      >
        <DashboardIcon />
